...
import { Bell, Menu, X, Home, PlusCircle, User } from "lucide-react";
        ...
        <div className="flex justify-around items-center h-16">
          ...
          {authStatus && (
            ...
            >
              ...
              {notifications.filter((n) => !n.read).length > 0 && (
                <span className="absolute top-0 right-4 bg-red-600 text-white text-xs w-4 h-4 flex items-center justify-center rounded-full">
                  {notifications.filter((n) => !n.read).length}
                </span>
              )}
            </button>
