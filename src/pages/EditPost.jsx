...
//       // Handle image update if needed
//       if (updatedPost.image && updatedPost.image[0]) {
//         const file = await appwriteService.uploadFile(updatedPost.image[0]);
...
//       initial={{ opacity: 0 }}
//       animate={{ opacity: 1 }}
//       className="min-h-screen bg-gradient-to-b from-gray-900 to-black px-3 sm:px-4 py-6 sm:py-8 md:py-12"
//     >
//       {/* Top Navigation */}
...
//         <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white text-center flex-1 md:flex-none">
//           Edit Post
//         </h2>
...
//         {/* Preview Card */}
//         {previewImage && (
//           <div className="mb-4 sm:mb-6 bg-gray-800/60 rounded-xl overflow-hidden border border-gray-700/50">
//             <div className="relative aspect-video overflow-hidden">
//               <img
//                 src={previewImage}
//                 alt={post.Title}
...
function EditPost() {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-screen bg-gradient-to-b from-gray-900 to-black py-6 sm:py-8 md:py-12 w-full px-3 sm:px-4"
    >
      {/* Top Navigation */}
      <div className="max-w-4xl mx-auto mb-4 sm:mb-6 flex items-center justify-between">
        <button
